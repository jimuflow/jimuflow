...
from jimuflow.components.core import DictLoopComponent
...
async def loop_component():
    component = create_component(DictLoopComponent)
    ...
    await component.process.update_variable("d", {"a": 0, "b": 1, "c": 2})
    return component
